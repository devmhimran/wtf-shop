...
-- AlterTable
ALTER TABLE "CustomOrderImage" ALTER COLUMN "orderId" DROP NOT NULL;
...
-- AlterTable
ALTER TABLE "ProductGallery" ALTER COLUMN "productId" DROP NOT NULL;
...
-- AlterTable
ALTER TABLE "QuantityDiscount" ALTER COLUMN "productId" DROP NOT NULL;
...
-- AddForeignKey
ALTER TABLE "QuantityDiscount" ADD CONSTRAINT "QuantityDiscount_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CustomOrderImage" ADD CONSTRAINT "CustomOrderImage_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE SET NULL ON UPDATE CASCADE;
