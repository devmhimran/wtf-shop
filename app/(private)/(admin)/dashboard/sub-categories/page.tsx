...
import { CreateSubCategoryForm } from '@/components/forms';
import { SubCategoriesCard } from '@/components/pages/sub-categories';
...
import { useGetAllSubCategories } from '@/hooks';
  ...
  return (
    <div className='space-y-6 w-full md:w-4/6 lg:w-3/6 mx-auto '>
      ...
      <AlertModal
        ...
        description=' '
      >
        <CreateSubCategoryForm setIsOpen={setAddCategoryOpen} />
      </AlertModal>
    </div>
  );
}
