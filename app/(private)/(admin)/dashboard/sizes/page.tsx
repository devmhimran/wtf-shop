...
import { CreateSizesForm } from '@/components/forms';
import { SizesCard } from '@/components/pages/sizes';
...
export default function SizesPage() {
  ...
  const { fetchAllSizesMutation, fetchAllSizesMutationData } =
  ...
  return (
    <div className='space-y-6 w-full md:w-5/6 lg:w-3/6 mx-auto '>
      ...
      <Card>
        ...
        <CardContent>
          {fetchAllSizesMutation.isLoading ? (
            <SizesSkeleton />
          ) : (
            <SizesCard data={fetchAllSizesMutationData?.data || []} />
          )}
      ...
      <AlertModal
        ...
        description=' '
      >
        <CreateSizesForm setIsOpen={setAddSizeModalOpen} />
      </AlertModal>
    </div>
  );
}
