...
export function TermsAndConditionsPageContent() {
  const { isLoading, data } = useQuery({
    queryKey: ['terms-and-conditions-page-content'],
    queryFn: async () =>
      await singularPagesApi.public
        ...
        <div className='container mx-auto px-4 py-16 md:py-24 relative z-10'>
          <div className='max-w-4xl mx-auto text-center'>
            <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 bg-linear-to-r from-primary to-primary/60 bg-clip-text text-transparent'>
              {data?.data?.title || 'Terms & Conditions'}
            </h1>
      ...
      <div className='container mx-auto px-4 py-12 md:py-16'>
        <div className='max-w-4xl mx-auto'>
            ...
            <CardContent className='p-8 md:p-12'>
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    data?.data?.content || '<p>Content coming soon...</p>',
                }}
              />
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mt-8'>
                    <div className='text-center p-6 rounded-lg bg-linear-to-br from-primary/10 to-primary/5 border'>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Clear and reasonable conditions
                      </p>
                    </div>
          ...
          {data?.data?.metaDescription && (
            <Card className='mt-8 bg-linear-to-r from-primary/5 to-secondary/5 border-primary/20'>
